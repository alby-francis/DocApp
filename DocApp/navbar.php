...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/js/bootstrap.min.js" integrity="sha384-Atwg2Pkwv9vp0ygtn1JAojH0nYbwNJLPhwyoVbhoPwBhjQPR5VtM2+xf0Uwh9KtT" crossorigin="anonymous"></script>
  <header class="p-3 mb-3 border-bottom">
    <div class="container">
      ...
      <img class="d-flex align-items-center mb-2 mr-3" src="logo.png" alt="Bootstrap" width="80" height="40">
  ...
  <div class="dropdown text-end ml-auto">
          ...
          <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
            ...
            <?php if ($_SESSION['role'] == 'patient') {?>
              <li><a class="dropdown-item" href="user_session.php">Home</a></li>
              <li><a class="dropdown-item" href="patientTodaysApp.php">My Todays Appointment</a></li>
            <li><a class="dropdown-item" href="myAppointmentsP.php">My Booking History</a></li>
            <?php }elseif ($_SESSION['role'] == 'admin') {?>
              <li><a class="dropdown-item" href="admin_session.php">Home</a></li>
            ...
            <li><a class="dropdown-item" href="admin_session.php">Doctor Booking Requests</a></li>
             <?php }elseif ($_SESSION['role'] == 'doctor') {?>
              <li><a class="dropdown-item" href="doctor_session.php">Home</a></li>
