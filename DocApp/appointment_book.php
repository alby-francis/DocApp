...
//<!-- result -->
	$doc_id = isset($_GET['doc_id'])?$_GET['doc_id']:"";
        ...
        if($num_row == 1)
        {
          ...
          $doc_f_name = $result['d_first_name'];
          $doc_l_name = $result['d_last_name'];
...
<section class=" p-4 d-flex justify-content-center mb-4">
      ...
      <div class="container text-center ">
        ...
        <div class="form-outline mb-2">
          <label class="d-flex p-2" for="exampleInputEmail3">Booking Appointment with</label>
                <input class="form-control form-control-sm mr-1" id="contactemail" name="doc_f_name$doc_f_name"
                placeholder="" value="<?php echo 'Dr. ' .  $doc_f_name ?>" readonly>
        <div class="form-notch"><div class="form-notch-leading" style="width: 9px;"></div><div class="form-notch-middle" style="width: 88.8px;"></div><div class="form-notch-trailing"></div></div></div>
  ...
  $sql = "INSERT INTO booking_request (d_id,d_first_name,d_last_name,cu_id,cu_first_name,cu_last_name,p_name,b_date,b_time)
  VALUES ('$doc_id','$doc_f_name','$doc_l_name','$c_id','$c_name','$c_lname','$p_name','$b_date','$b_time')";
